...
- **File Formats** → `.pbix` (Power BI File - Get it in Raw File), `.csv` (data import - [Details](Details.csv), [Orders](Orders.csv), `.png` [Dashboard Preview](Data_analyzed-Dashboard-Screenshot.png) & [Dashboard background](Background-dark-gradient.jpg)
